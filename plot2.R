## Exploratory Data Analysis Course Project 1:Script for producing plot 2 
...
# Plot xy line plot of Day vs. Global Active power, no x-axislabel
plot(power.mut$DateTime,power.mut$Global_active_power,type="l",
